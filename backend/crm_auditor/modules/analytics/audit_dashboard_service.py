        ...
        checklist.append(
            {
                ...
                "ok": total > 0,
                "hint": "Execute um sync (token direto do Kommo) e confira crm_sync_runs." if total == 0 else None,
            }
        )
        checklist.append(
            {
        ...
        checklist.append(
            {
                ...
                "hint": (
                    "Amplie o sync (API do Kommo) ou permissões — notas e eventos vieram vazios."
