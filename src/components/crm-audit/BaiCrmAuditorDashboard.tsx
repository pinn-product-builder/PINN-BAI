      ...
      <div className="bai-main">
        ...
        {data && (
          <>
              ...
              {!analysis ? (
                ...
                <div className="bai-prose-block">
                  ...
                  <p className="bai-muted-cap" style={{ marginTop: "1.25rem" }}>
                    Fonte: {analysis.source ? String(analysis.source) : "Diagnóstico determinístico (sem provedor de IA configurado)"}
                    {analysis.model ? ` · ${String(analysis.model)}` : ""}
                  </p>
                  {!analysis.source && (
                    <p className="bai-muted-cap" style={{ marginTop: "0.25rem", color: "#F59E0B" }}>
                      ⚠️ Parecer gerado sem provedor de IA — configure OPENAI_API_KEY ou LOVABLE_API_KEY no Supabase para análise enriquecida.
                    </p>
                  )}
                </div>
              )}
            ...
            <footer className="bai-footer">BAI CRM Auditor · Kommo · {apiBase}</footer>
          </>
        )}
      </div>
    </div>
