...
const TARGET_METRICS: { value: string; label: string; description: string }[] = [
  ...
  { value: 'conv_lead_to_meeting_30d', label: 'Conv. Lead → Reunião', description: 'Leads que chegaram a reunião confirmada ÷ total de leads. Mede qualidade da prospecção.' },
  { value: 'conv_lead_to_won_30d', label: 'Conv. Lead → Fechamento', description: 'Leads ganhos ÷ total de leads. Mede performance full funnel.' },
  { value: 'conv_stage_avg_30d', label: 'Conv. média por etapa', description: 'Média da passagem entre etapas do funil. Identifica gargalos.' },
  { value: 'conversion_rate', label: 'Taxa de Conversão (genérica)', description: 'Métrica ambígua — prefira uma das 3 conversões específicas acima.' },
