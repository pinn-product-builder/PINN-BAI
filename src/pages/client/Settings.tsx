...
import { Loader2, Save, Palette, Type, Image, Eye, Upload, Check } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Personalize a identidade visual do seu dashboard
          </p>
        </div>
        <Button
        ...
        <TabsContent value="brand" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>URL do logotipo exibido no menu lateral. Recomendado: 200×40px, fundo transparente.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <div className="w-48 h-14 rounded-xl border border-border bg-sidebar flex items-center justify-center overflow-hidden p-2">
                  {logoUrl ? (
                    <img
                      src={logoUrl}
                      alt="Logo preview"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={settings.showAINarrative !== false}
                  onCheckedChange={(checked) => setSettings({ ...settings, showAINarrative: checked })}
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                ...
                <Switch
                  checked={settings.showVoiceBriefing !== false}
                  onCheckedChange={(checked) => setSettings({ ...settings, showVoiceBriefing: checked })}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              ...
              <div className="w-64 rounded-xl border border-border bg-sidebar overflow-hidden">
                ...
                <div className="p-3 space-y-1">
                  <div
                    className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-white"
                    style={{ backgroundColor: primaryColor }}
                  >
